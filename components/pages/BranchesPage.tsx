...
const BranchesPage: React.FC = () => {
    const branches: Branch[] = [
        ...
        },
        {
            id: 2,
            name: 'فرع الإسكندرية',
            address: '15 شارع سعد زغلول، محطة الرمل، الإسكندرية',
            phone: '03-4876543',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'alex@sharia.org.eg',
            governorate: 'الإسكندرية',
        },
        {
            id: 3,
            name: 'فرع الجيزة',
            address: '40 شارع الهرم، الجيزة',
            phone: '02-33456789',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'giza@sharia.org.eg',
            governorate: 'الجيزة',
        },
        {
            id: 4,
            name: 'فرع المنصورة',
            address: '8 شارع الجمهورية، المنصورة، الدقهلية',
            phone: '050-2234567',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'mansoura@sharia.org.eg',
            governorate: 'الدقهلية',
        },
        {
            id: 5,
            name: 'فرع طنطا',
            address: '12 شارع الجيش، طنطا، الغربية',
            phone: '040-3345678',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'tanta@sharia.org.eg',
            governorate: 'الغربية',
        },
        {
            id: 6,
            name: 'فرع أسيوط',
            address: '20 شارع صلاح سالم، أسيوط',
            phone: '088-2123456',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'assiut@sharia.org.eg',
            governorate: 'أسيوط',
        },
        {
            id: 7,
            name: 'فرع المنيا',
            address: '5 شارع كورنيش النيل، المنيا',
            phone: '086-2345678',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'minya@sharia.org.eg',
            governorate: 'المنيا',
        },
        {
            id: 8,
            name: 'فرع بورسعيد',
            address: '18 شارع الجمهورية، بورسعيد',
            phone: '066-3234567',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'portsaid@sharia.org.eg',
            governorate: 'بورسعيد',
        },
        {
            id: 9,
            name: 'فرع الإسماعيلية',
            address: '22 شارع صلاح الدين، الإسماعيلية',
            phone: '064-3123456',
            workingHours: 'السبت - الخميس: 9 صباحاً - 5 مساءً',
            email: 'ismailia@sharia.org.eg',
